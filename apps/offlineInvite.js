...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<svg class="offline-envelope-svg" viewBox="0 0 212 128" aria-hidden="true">'
    + '<path d="M18 28 L194 28 L194 110 Q194 116 188 116 L24 116 Q18 116 18 110 Z" fill="#111"/>'
    + '<path d="M18 28 L106 84 L194 28" fill="#111"/>'
    + '<path d="M14 24 L190 24 L190 106 Q190 112 184 112 L20 112 Q14 112 14 106 Z" fill="#f6f6f6" stroke="#555" stroke-width="1.5"/>'
    + '<path d="M14 24 L102 78 L190 24" fill="#dcdcdc" stroke="#555" stroke-width="1.5" stroke-linejoin="round"/>'
    + '<path d="M14 24 L102 78 L190 24" fill="none" stroke="#111" stroke-width="2.8" stroke-linejoin="round"/>'
    ...
    + '<path d="M14 24 L14 106" stroke="#555" stroke-width="1.5"/>'
    + '<path d="M190 24 L190 106" stroke="#555" stroke-width="1.5"/>'
    + '</svg>'
