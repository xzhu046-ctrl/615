...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<path d="M18 28 L194 28 L194 110 Q194 116 188 116 L24 116 Q18 116 18 110 Z" fill="#111"/>'
    + '<path d="M18 28 L106 84 L194 28" fill="#111"/>'
    + '<path d="M14.5 24.5 L189.5 24.5 L189.5 105.5 Q189.5 111.5 183.5 111.5 L20.5 111.5 Q14.5 111.5 14.5 105.5 Z" fill="#f6f6f6" stroke="#555" stroke-width="1.4" stroke-linejoin="round"/>'
    + '<path d="M14.5 24.5 L102 78 L189.5 24.5" fill="#dcdcdc" stroke="#555" stroke-width="1.4" stroke-linejoin="round"/>'
    + '<path d="M14.5 24.5 L102 78 L189.5 24.5" fill="none" stroke="#111" stroke-width="2.6" stroke-linejoin="round" stroke-linecap="round"/>'
    + '<path d="M14 24 L102 78 L190 24" fill="none" stroke="#111" stroke-width="1.2" stroke-linejoin="round" opacity=".42" transform="translate(2 2)"/>'
    + '<path d="M14.5 24.5 L14.5 105.5" stroke="#555" stroke-width="1.4" stroke-linecap="round"/>'
    + '<path d="M189.5 24.5 L189.5 105.5" stroke="#555" stroke-width="1.4" stroke-linecap="round"/>'
    + '</svg>'
