...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<path d="M22 30 Q27 24 34 24 L170 24 Q177 24 182 30 L106 80 Z" fill="#111" opacity=".94"/>'
    + '<rect x="13.5" y="23.5" width="176" height="88" rx="10" ry="10" fill="#f7f7f7" stroke="#595959" stroke-width="1.25"/>'
    + '<path d="M20.5 29 Q26.5 23.5 33.5 23.5 L169.5 23.5 Q176.5 23.5 182.5 29 L102 78.5 Z" fill="#d9d9d9" stroke="#595959" stroke-width="1.25" stroke-linejoin="round"/>'
    + '<path d="M21.5 29.5 L102 78.5 L181.5 29.5" fill="none" stroke="#101010" stroke-width="2.15" stroke-linejoin="round" stroke-linecap="round"/>'
    + '<path d="M22.5 31 L102 79.5 L180.5 31" fill="none" stroke="rgba(0,0,0,.15)" stroke-width="3.6" stroke-linejoin="round" stroke-linecap="round"/>'
