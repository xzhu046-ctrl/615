...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<svg class="offline-envelope-svg" viewBox="0 0 176 102" aria-hidden="true">'
    + '<rect x="8" y="14" width="160" height="80" rx="9" ry="9" fill="#f3f3f3" stroke="#555" stroke-width="1.4"/>'
    + '<path d="M8 94 L168 94" stroke="#111" stroke-width="3" stroke-linecap="round"/>'
    + '<path d="M8 14 L88 66 L168 14" fill="#dddddd" stroke="#555" stroke-width="1.4" stroke-linejoin="round"/>'
    + '<path d="M8 94 L88 40 L168 94" fill="#f3f3f3" stroke="#555" stroke-width="1.4" stroke-linejoin="round"/>'
    + '<path d="M8 14 L88 66 L168 14" fill="none" stroke="#111" stroke-width="2.4" stroke-linejoin="round" opacity=".95"/>'
    + '</svg>'
