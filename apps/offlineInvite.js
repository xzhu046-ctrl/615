...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<path d="M17 28.5 H186" fill="none" stroke="rgba(255,255,255,.65)" stroke-width="1" stroke-linecap="round"/>'
    ...
    + '<path d="M22.5 26.5 L102 75 L180.5 26.5" fill="none" stroke="rgba(255,255,255,.28)" stroke-width="1.15" stroke-linejoin="round" stroke-linecap="round"/>'
    + '</g>'
