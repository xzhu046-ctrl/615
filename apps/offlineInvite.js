...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<rect x="16" y="27" width="176" height="88" rx="9" ry="9" fill="#111"/>'
    + '<path d="M18 28 Q22 24 28 24 L180 24 Q186 24 190 28 L106 80 Z" fill="#111" opacity=".94"/>'
    + '<rect x="13.5" y="23.5" width="176" height="88" rx="8.5" ry="8.5" fill="#f7f7f7" stroke="#595959" stroke-width="1.25"/>'
    + '<path d="M13.5 25.5 Q17.5 23.5 23.5 23.5 L179.5 23.5 Q185.5 23.5 189.5 25.5 L102 78.5 Z" fill="#d9d9d9" stroke="#595959" stroke-width="1.25" stroke-linejoin="round"/>'
    + '<path d="M15.5 25.5 L102 78.5 L187.5 25.5" fill="none" stroke="#101010" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round"/>'
    + '<path d="M16.5 27.5 L102 79.5 L186.5 27.5" fill="none" stroke="rgba(0,0,0,.18)" stroke-width="4.2" stroke-linejoin="round" stroke-linecap="round"/>'
    + '<path d="M13.5 31.5 L13.5 103.5" stroke="#595959" stroke-width="1.15" stroke-linecap="round"/>'
    + '<path d="M189.5 31.5 L189.5 103.5" stroke="#595959" stroke-width="1.15" stroke-linecap="round"/>'
    + '</svg>'
