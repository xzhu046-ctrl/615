...
function renderOfflineInviteBubble(bubble, raw, viewRole, msgId){
  ...
  bubble.innerHTML = '<div class="offline-bubble-shell' + sideClass + '">'
    ...
    + '<path d="M22 28.5 Q27 22.5 34 22.5 L170 22.5 Q177 22.5 182 28.5 L106 78.5 Z" fill="#111" opacity=".94"/>'
    + '<rect x="13.5" y="23.5" width="176" height="88" rx="10" ry="10" fill="#f7f7f7" stroke="#595959" stroke-width="1.25"/>'
    + '<path d="M20.5 27.5 Q26.5 22 33.5 22 L169.5 22 Q176.5 22 182.5 27.5 L102 77 Z" fill="#d9d9d9" stroke="#595959" stroke-width="1.25" stroke-linejoin="round"/>'
    + '<path d="M21.5 28 L102 77 L181.5 28" fill="none" stroke="#101010" stroke-width="2.15" stroke-linejoin="round" stroke-linecap="round"/>'
    + '<path d="M22.5 29.5 L102 78 L180.5 29.5" fill="none" stroke="rgba(0,0,0,.15)" stroke-width="3.6" stroke-linejoin="round" stroke-linecap="round"/>'
