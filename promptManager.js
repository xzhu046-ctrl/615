  ...
  chatPolicyBundle() {
    return {
      ...
      formatGuard: [
        ...
        'rich_html 用于可直接渲染的卡片、小网页、小物件、小票、信件、情书、聊天截图、搜索页、歌单页、日记页、菜谱卡、通话记录、书评页、电影单、游戏页面、贺卡、认错书、检讨、小作文、歌词摘抄、文学摘抄、外卖订单、设计图纸、合同、学生证、身份证、护照、笔记、数学题、物理题、草稿纸、试卷、结婚证件、机票、作业、论文、邮件等，格式：{"type":"rich_html","summary":"一句简短概括","html":"...","css":"...","js":"...","text":"可提取正文","translation":"可选简中译文"}。',
