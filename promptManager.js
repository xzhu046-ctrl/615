  ...
  chatPolicyBundle() {
    return {
      ...
      replyGuide: [
        ...
        'rich_html 不是只在情书或票据场景才用。只要氛围合适，你也可以偶尔主动发一个 SURPRISE 小卡片，比如聊天记录、搜索记录、歌单、日记、涂鸦、菜谱、通话记录、书单、电影单、游戏时长、游戏页面、书评、贺卡、认错书、检讨、小作文、歌词摘抄、文学摘抄、外卖订单、设计图纸、合同、学生证、身份证、护照、笔记、数学题、物理题、草稿纸、试卷、结婚证件、机票、作业、论文、邮件、影评、药品单、医院开的单子、知乎帖子、小说简介、伪小红书帖子、直播间、抖音样式页、社交媒体主页、社交媒体帖子、社交媒体评论、测评、repo、银行账单、银行流水、法院传票、学签、旅游签、工签、银行卡、小费条、电影票、飞机票、火车票、塔罗牌、签文、百度搜索结果、论坛帖子、便签、清单、网页、聊天截图或别的精致小物件。',
        '当用户明确要你做“情书、小卡片、网页、票根、论坛贴、搜索结果、塔罗、签文、海报、帖子、笔记、小物件、歌单、日记、菜谱、贺卡、书单、电影单、游戏页面、聊天记录样式页面、认错书、检讨、小作文、歌词摘抄、文学摘抄、外卖订单、设计图纸、合同、学生证、身份证、护照、数学题、物理题、草稿纸、试卷、机票、作业、论文、邮件、影评、药品单、医院开的单子、知乎帖子、小说简介、伪小红书帖子、直播间、抖音样式页、社交媒体主页、社交媒体帖子、社交媒体评论、测评、repo、银行账单、银行流水、法院传票、学签、旅游签、工签、银行卡”时，优先 rich_html，不要退回普通 text。',
        'rich_html 要把重点放在可渲染成品本身，风格精致、可读、别乱飞，也别做成粗糙 demo，更不能只吐一段空 html 或一句说明。一旦决定发 rich_html，就把 html/css/js 都认真写完整。',
        'rich_html 要有真正的成品感：层级清楚、留白克制、结构稳定、字体和装饰有主题，不要像匆忙拼的样机。必要时可以带细小动画、轻交互、hover、按钮反馈，但必须自然克制。',
