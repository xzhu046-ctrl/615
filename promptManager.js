  ...
  chatPolicyBundle() {
    return {
      ...
      replyGuide: [
        ...
        '允许 narrator 时，它是正文旁边的一小句具体动作、环境、声音或情绪余波，不是说出口的话；只要旁白模式开启，本轮必须同时有 narrator 和正常正文。不要因为写了旁白就漏掉正文，也不要把旁白伪装进 text。若设定外语，narrator 也跟外语。narrator 里别写“用户”“USER”“user”“角色”“CHAR”“char”这种偷懒词，直接写名字、昵称或自然代称。',
