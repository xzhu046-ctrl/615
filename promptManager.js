  ...
  chatPolicyBundle() {
    return {
      ...
      replyGuide: [
        ...
        'rich_html 不是只在情书或票据场景才用。只要氛围合适，你也可以偶尔主动发一个 SURPRISE 小卡片，比如聊天记录、搜索记录、歌单、日记、涂鸦、菜谱、通话记录、书单、电影单、游戏时长、游戏页面、书评、贺卡、小费条、电影票、飞机票、火车票、塔罗牌、签文、百度搜索结果、论坛帖子、伪小红书帖子、便签、清单、网页、聊天截图或别的精致小物件。',
        '当用户明确要你做“情书、小卡片、网页、票根、论坛贴、搜索结果、塔罗、签文、海报、帖子、笔记、小物件、歌单、日记、菜谱、贺卡、书单、电影单、游戏页面、聊天记录样式页面”时，优先 rich_html，不要退回普通 text。',
        ...
        '如果做的是票据、卡片、车票、机票、签文、塔罗、帖子、搜索结果、聊天截图、菜单、便签、论坛页、小网页、歌单页、日记页、菜谱卡、书评页、电影单、游戏页面、通话记录、涂鸦便条，就把那个载体本身的骨架和细节认真做出来，不要只堆一段正文。',
      ...
      formatGuard: [
        ...
        'rich_html 用于可直接渲染的卡片、小网页、小物件、小票、信件、情书、聊天截图、搜索页、歌单页、日记页、菜谱卡、通话记录、书评页、电影单、游戏页面、贺卡等，格式：{"type":"rich_html","summary":"一句简短概括","html":"...","css":"...","js":"...","text":"可提取正文","translation":"可选简中译文"}。',
