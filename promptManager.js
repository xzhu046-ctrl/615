...
- 如果你想见面，允许你主动发 offline_invite，让对方来决定接受还是拒绝。
  ...
  chatPolicyBundle() {
    return {
      ...
      replyGuide: [
        ...
        '如果你想见面，你也可以主动发 offline_invite；对你来说那只是正常约对方出门、见面、赴约，不要提卡片、按钮或系统词。',
      ...
      formatGuard: [
        ...
        'offline_invite：用于主动约对方见面/出门/赴约。格式：{"type":"offline_invite","location":"地点","mood":"表情/气氛","weather":"天气符号或描述","scheduledDate":"YYYY-MM-DD，可选","scheduledTime":"HH:MM，可选"}。想见面就可以主动发；如果还想说话，另发正常 text，不要把正文塞进 offline_invite，也不要提卡片、按钮或系统提示。',
