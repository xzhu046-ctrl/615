  ...
  chatPolicyBundle() {
    return {
      ...
      replyGuide: [
        ...
        '允许 narrator 时，它只能偶尔做陪衬。默认先发真正说出口的话；旁白最多只补一小句具体动作、环境、声音或情绪余波。不要因为用户用了旁白输入，就整轮跟着只回旁白。若设定外语，narrator 也跟外语。narrator 里别写“用户”“USER”“user”“角色”“CHAR”“char”这种偷懒词，直接写名字、昵称或自然代称。',
